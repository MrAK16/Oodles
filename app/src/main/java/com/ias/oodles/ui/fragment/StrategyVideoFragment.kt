...
import com.ias.oodles.ui.adapter.PrelimsListAdapter
import com.ias.oodles.ui.adapter.PtTestListAdapter
import com.ias.oodles.ui.adapter.StrategyVideoAdapter
...
class StrategyVideoFragment(context: Context) : Fragment() {
    ...
    private var materialListAdapter: StrategyVideoAdapter? = null
    var pageNo = 0
    var limit = 10
    ...
    private fun setMaterialAdapter() {
        ...
        materialListAdapter = context?.let { StrategyVideoAdapter(it, packageList) }
